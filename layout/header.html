<header id="header">
  <div id="social-networks">
    <a href="https://www.facebook.com/profile.php?id=61556652903051">
      <svg
    ...
    <a href="https://api.whatsapp.com/send?phone=604982792">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink"
        viewBox="0 0 48 48"
  ...
  <div class="header">
    ...
    <div class="content-navigation">
      <button id="toggle-header-menu" type="button" data-status="open">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <ul class="navegation">
        ...
        <li>
          <a href="#" class="active">604982792</a>
        </li>
      </ul>
    </div>
  </div>
