...
async function getSaleDetail() {
  try {
    ...
    formdata.append("operacion", "get-detail-by-id");
    formdata.append("venta_id", saleId);

    const requestOptions = { method: "POST", body: formdata };

    const sale = await fetch(saleEndpoint, requestOptions);
...
function handleSaleUpdate(params) {
  const formdata = new FormData();
...
$("#button-update-sale").addEventListener("click", handleSaleUpdate);
